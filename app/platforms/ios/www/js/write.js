...
var captureSuccess = function(mediaFiles) {
    ...
    if(jQuery(".attach").length > 0) jQuery(".attach").remove();
    var html = 	'<video onclick="removeImg()" class="attach" id="video_user" controls="controls" width="50%" height="100px" name="preview" data-src="'+path+'" src="'+path+'"></video>';
...
function show_write(op){
	if(op) {
    	...
    	if($('.attach').length > 0) $('.attach').remove();
