...
screen_grupos.show = function(){screen_grupos.removeClass('downed');};
...
screen_single_grupo.show = function(){screen_single_grupo.removeClass('righted');};
...
function create_grupo(){
    ...
    screen_grupos.ajax_search = $.ajax({
        ...
        data: data,
        success: function(a,b,c){
            screen_grupos.wrapper.prepend(a);
...
function publicar_grupo_redes(src,url){
	...
	if($(".pgmbutton").hasClass('loading')) return false;
